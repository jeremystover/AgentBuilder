import { D1CredentialVault, mountCredentialsApi } from "@agentbuilder/credential-vault";
...
function slugFromFeedUrl(feedUrl: string): string {
  // Examples:
  //   https://www.wired.com/feed/rss                          → "rss"
  //   https://www.wired.com/feed/category/business/rss        → "category-business"
  //   https://www.wired.com/feed/tag/ai/rss                   → "tag-ai"
