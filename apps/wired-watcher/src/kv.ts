...
export async function addSeenIds(env: Env, slug: string, newIds: string[]): Promise<void> {
  ...
  await env.WIRED_STATE.put(seenKey(slug), JSON.stringify(capped));
}
