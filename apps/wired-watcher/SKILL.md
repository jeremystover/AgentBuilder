...
- `KEK_BASE64`     — base64 of 32 random bytes; AES-256-GCM KEK for the vault. Generate with `pnpm cred genkey`.
...
# 2. Schema
wrangler d1 execute wired-watcher-vault --file=./migrations/0001_init.sql
